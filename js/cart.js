          ...
          <div class="panel-footer">
            <div class="row buyInfo">
              <p class="col-sm-4 buyNum">
                TOTAL NUM: <span class="text-danger cartNum">${ total }</span> 件商品
              </p>
              <p class="col-sm-4 buyMoney">
                TOTAL PRICE: $ <span class="text-danger total">${ totalMoney.toFixed(2) }</span> 
              </p>
              <p class="col-sm-4 operate">
                <button class="btn btn-success" ${ totalMoney === 0 ? 'disabled' : '' }>PAY NOW</button>
                <button class="btn btn-danger kong">CLEAR</button>
